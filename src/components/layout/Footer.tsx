        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <h3 className="text-white font-bold text-lg mb-6">
              <span className="text-brand-green">Karla</span> Cleaning Crew
            </h3>
            ...
            <div className="space-y-4">
              <a href="tel:+46707402080" className="flex items-center gap-3 text-sm hover:text-brand-green transition-colors">
                <Phone size={18} className="text-brand-green flex-shrink-0" />
                <span>+46 707 40 20 80</span>
              </a>
              <a
                href="mailto:Info@karlacleaningcrew.se"
                className="flex items-center gap-3 text-sm hover:text-brand-green transition-colors"
              >
            ...
            <div className="mt-8 space-y-2">
              <div className="flex items-center gap-2 text-sm">
                <BadgeCheck size={16} className="text-brand-green flex-shrink-0" />
          ...
          <div>
            <h4 className="text-white font-semibold mb-6">Navigering</h4>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tjanster" className="hover:text-brand-green transition-colors text-sm font-semibold">
                  Se alla tjänster →
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wide mb-2">Adress</p>
                <p className="text-sm">
                  Lodjursstråket 1
                  <br />
                  417 51 Göteborg
              ...
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wide mb-2">Öppet</p>
                <p className="text-sm">
                  Mån–Fre: 08:00–17:00
                  <br />
                  Lör–Sön: Stängt
              ...
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wide mb-3">Följ oss</p>
